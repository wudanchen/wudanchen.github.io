#!/usr/bin/env node
import{removeEndingSlash as v,removeLeadingSlash as h}from"@vuepress/helper";import{createCommand as C}from"commander";import{resolveCliAppConfig as w,resolveUserConfigPath as y,resolveUserConfigConventionalPath as $,loadUserConfig as S,resolveAppConfig as b,transformUserConfigToPlugin as A}from"vuepress/cli";import{createBuildApp as P}from"vuepress/core";import{fs as t,logger as n,path as a}from"vuepress/utils";var j="2.0.0-rc.115",x={version:j};const E=e=>`<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
